...
import { usersForgotPasswordPost } from "../../../api/client";
...
export default function ForgotPassword() {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    try {
      const response = await usersForgotPasswordPost("/forgot-password", {
        email: email,
      });
    ...
    >
      ...
      <div className="flex flex-col text-center items-center justify-center space-y-2 mt-8">
        ...
        <form
          ...
          className="w-full flex flex-col items-center space-y-4 pt-2 px-4 2xl:px-0 xl:px-0 lg:px-0 md:px-0"
        >
          <BasicInput
            type="email"
            name="email"
