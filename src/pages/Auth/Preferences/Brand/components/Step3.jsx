...
export default function Step3(){
    ...
    <BasicInput name="about" placeholder="Brief Description Of The Company" multiline rows={4} phcolor="grey" phweight={100}   required custom="w-full mt-2"/>
    <p className="text-zinc-400 self-start text-sm">Company Milestones</p>
    <BasicInput name="milestone" placeholder="Significant Milestones You Have Achieved" multiline rows={4} phcolor="grey" phweight={100} required custom="w-full mt-2"/>
