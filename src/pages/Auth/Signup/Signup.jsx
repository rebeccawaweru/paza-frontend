...
import client, { usersSignupPost } from "../../../api/client";
...
export default function Signup() {
  ...
  const handleSubmit = async (e) => {
    ...
    if (confirmpassword !== values.password) {
      ...
      try {
        const response = await usersSignupPost("/signup", values);
    ...
    >
      <div className="flex flex-col text-center items-center justify-center space-y-2 mt-24 pb-8">
        ...
        <form
          ...
          className="w-full flex flex-col items-center space-y-6 pt-2 px-4 2xl:px-0 xl:px-0 lg:px-0 md:px-0"
        >
          <ToastContainer theme="dark" />
          <BasicInput
            custom="grey w-full 2xl:w-1/2 xl:w-1/2 lg:w-1/2 md:w-2/3 sm:w-2/3"
            type="text"
            name="firstname"
          ...
          <div className="w-full 2xl:w-1/2 xl:w-1/2 lg:w-1/2 md:w-2/3 sm:w-2/3 grid grid-cols-2 ">
            ...
            >
              <FormControlLabel
                className="border border-orange-500 rounded-full px-2 w-24 h-8"
                value="Male"
              ...
              />
              <FormControlLabel
                className="border border-orange-500 rounded-full pr-2 w-26 h-8"
                value="Female"
                control={<Radio sx={radiocls} size="extrasmall" />}
          ...
          <div className="w-full 2xl:w-1/2 xl:w-1/2 lg:w-1/2 md:w-2/3 sm:w-2/3 grid grid-cols-2 gap-2">
            <BasicInput
              ...
              required
              placeholder="+254"
              start="bi bi-telephone text-white"
            />
            <BasicInput
              custom="grey w-full"
              type="text"
              ...
              required
              placeholder="City"
              start="bi bi-geo-alt-fill text-white"
            />
          </div>
          <BasicInput
            custom="grey w-full 2xl:w-1/2 xl:w-1/2 lg:w-1/2 md:w-2/3 sm:w-2/3"
          ...
          <BasicButton
            title="Sign up"
            custom="w-full 2xl:w-1/2 xl:w-1/2 lg:w-1/2 md:w-2/3 sm:w-2/3 text-lg"
          />
        </form>
      </div>
    </AuthWrapper>
