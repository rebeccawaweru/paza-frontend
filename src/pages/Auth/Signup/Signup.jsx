...
export default function Signup(){
    ...
    <div className="w-full 2xl:w-1/2 xl:w-1/3 lg:w-1/3 md:w-1/2 sm:w-2/3 grid grid-cols-2 gap-2">
    ...
    <BasicButton title="Sign up" custom="w-full 2xl:w-1/2 xl:w-1/3 lg:w-1/3 md:w-1/2 sm:w-2/3 text-lg"/>
    </form>
    </div>
    </AuthWrapper>
}