...
export default function Content(props){
    ...
    const permission = props.createdby === (account.creatorname || account.company || user.email);
    const handleDelete = () => {
        Swal.fire({
         title:"Are you sure ?",
         ...
         confirmButtonText:"Delete",
           ...
           campaignsDelete('/campaigns/'+props._id).then((response)=> {
    ...
    return (
        <div key={props.key} className="grey px-4 py-6 block 2xl:flex xl:flex lg:flex md:flex items-center justify-between rounded-md cursor-pointer hover:border hover:border-zinc-500">
            ...
            <p className="bg-green-800 rounded-lg px-4 cursor-ponter hover:scale-110"  onClick={props.view}>Open</p>
