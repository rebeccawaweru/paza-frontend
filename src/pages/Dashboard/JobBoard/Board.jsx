        ...
        <Dashboard sidebar={<SideBar/>}>
          ...
          <Grid item xs={10} sm={10} position="relative">
            ...
            <div className="col-span-2">
                ...
                <div className="flex flex-wrap">
                  {labelArray.map((item,index) => {
                    return  <div key={index} className="p-4 my-2 mr-2 rounded-md border border-zinc-400">{item.label}</div>
                  })}
                </div>
                 <p className="font-bold">About Job</p>
                 <p className="text-zinc-200">Lorem ipsum dolor sit amet consectetur adipisicing elit. Accusamus maiores architecto distinctio aspernatur! Reiciendis exercitationem facere consequatur iusto deserunt dolorem qui, minus repellat ipsum consequuntur sunt commodi. Pariatur, omnis! Sint.</p>
            ...
            <div className="col-span-1 flex flex-col space-y-4">
                ...
                <button className="hover:scale-90 border border-orange-700 flex text-center items-center justify-center p-2 font-bold"><i className="bi bi-bookmark text-orange-700 mx-2"></i>Save job</button>
