...
export default function Step1(){
    const {setStep, handleSubmit, values, handleChange} = useContext(JobContext)
    return <form onSubmit={handleSubmit} className="space-y-6 p-4 text-center">
     ...
     <BasicInput name="title" value={values.title} onChange={handleChange} custom="w-full grey" placeholder="Job Title" phcolor="grey" phweight={600} required/>
     <BasicInput name="description" value={values.description} onChange={handleChange} custom="w-full grey" placeholder="About / Description" multiline rows={5} phcolor="grey" phweight={600} required/>
