...
import client, { attachmentsPost } from "../../../api/client";
...
export default function CreateTask() {
  ...
  async function upload() {
    ...
    const res = await attachmentsPost("/attachments", formData);
              ...
              >
                {assignee.length > 0 ? (
                  ...
                  <p className="font-semibold text-red-500">
                    <i className="bi bi-exclamation-triangle mr-1"></i>Kindly
                    add members to assign task...
                  </p>
                )}
              </div>
            </div>
