          ...
          <div className="p-4 space-y-6">
            <div className="flex flex-col 2xl:flex-row xl:flex-row lg:flex-row md:flex-row sm:flex-row justify-between">
              ...
              <BasicButton
                ...
                title="+ Create Task"
                custom="text-white hover:text-black"
              />
            </div>
            <div className="flex space-x-12 cursor-pointer text-sm">
              <p
                className={`${
                  tab === "tasks" ? "text-orange-700" : "text-zinc-300"
                }`}
              >
                <i className="bi bi-grid mr-2"></i>Tasks
              </p>
              <p
                className={`${
                  tab === "calender" ? "text-orange-700" : "text-zinc-300"
                }`}
              >
                <i className="bi bi-calendar mr-2"></i>Calender
              </p>
            </div>
